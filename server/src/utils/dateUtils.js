...
exports.getDateRange = (query) => {
  ...
  if (query.start_date || query.end_date) {
    ...
    return {
      ...
      sqlFilterAlt: `ordered_at AT TIME ZONE 'Asia/Kolkata' >= $1::DATE AND ordered_at AT TIME ZONE 'Asia/Kolkata' < ($2::DATE + INTERVAL '1 day')`, // for tables that use ordered_at
      sqlFilterCreatedAt: `created_at AT TIME ZONE 'Asia/Kolkata' >= $1::DATE AND created_at AT TIME ZONE 'Asia/Kolkata' < ($2::DATE + INTERVAL '1 day')`, // for tables that use created_at
  ...
  return {
    ...
    sqlFilter: `date >= $1 AND date <= $2`,
    sqlFilterAlt: `ordered_at AT TIME ZONE 'Asia/Kolkata' >= $1::DATE AND ordered_at AT TIME ZONE 'Asia/Kolkata' < ($2::DATE + INTERVAL '1 day')`,
    sqlFilterCreatedAt: `created_at AT TIME ZONE 'Asia/Kolkata' >= $1::DATE AND created_at AT TIME ZONE 'Asia/Kolkata' < ($2::DATE + INTERVAL '1 day')`,
    params: [start, end]
  };
};
